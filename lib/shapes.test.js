...
describe('shapes', () => {
    ...
    test('Should create a blue triangle with text yellow "TXT"', () => {
        ...
        expect(test.render()).toBe(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="transparent" /><polygon points="150,18 244,182 56,182" fill="blue" /><text x="145" y="150" font-size="60" text-anchor="middle" fill="yellow">TXT</text></svg>`)
    })
